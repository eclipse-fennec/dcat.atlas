...
public interface DataServiceAdminService extends DataServiceReadOnlyService{
    ...
    /**
     * Deletes the data service under {@code id}.
     *
     * <h4>What {@code cascade} decides</h4>
     *
     * A data service may be referenced by other resources. With {@code cascade} {@code false}
     ...
     * and the delete — is one commit, so no reader ever sees a state where the data service is
     ...
     *
     * @param id      the data service to delete
     ...
     *                                is {@code false}
     */
    List<String> deleteDataService(String id, boolean cascade);
