 ...
 *   <li>{@link dcat.DCATAPRoot#getDatasetSeries <em>Dataset Series</em>}</li>
 * </ul>
 *
...
public interface DCATAPRoot extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Dataset Series</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Dataset Series</em>' containment reference.
	 * @see #setDatasetSeries(DatasetSeries)
	 * @see dcat.DcatPackage#getDCATAPRoot_DatasetSeries()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='DatasetSeries' namespace='##targetNamespace'"
	 * @generated
	 */
	DatasetSeries getDatasetSeries();

	/**
	 * Sets the value of the '{@link dcat.DCATAPRoot#getDatasetSeries <em>Dataset Series</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Dataset Series</em>' containment reference.
	 * @see #getDatasetSeries()
	 * @generated
	 */
	void setDatasetSeries(DatasetSeries value);
