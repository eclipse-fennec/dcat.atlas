...
public class DistributionImpl extends IdentifiedResourceImpl implements Distribution {
	 ...
	 * @ordered
	 */
	protected static final BigInteger BYTE_SIZE_EDEFAULT = null;
	 ...
	 * @generated
	 */
	public void setByteSize(BigInteger newByteSize) {
		BigInteger oldByteSize = byteSize;
		byteSize = newByteSize;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatPackage.DISTRIBUTION__BYTE_SIZE, oldByteSize, byteSize));
	}
	...
	public void setSpatialResolutionInMeters(BigDecimal newSpatialResolutionInMeters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatPackage.DISTRIBUTION__SPATIAL_RESOLUTION_IN_METERS, oldSpatialResolutionInMeters, spatialResolutionInMeters));
	}
	...
	public void setTemporalResolution(Duration newTemporalResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatPackage.DISTRIBUTION__TEMPORAL_RESOLUTION, oldTemporalResolution, temporalResolution));
	}
	...
	public NotificationChain basicSetChecksum(Checksum newChecksum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DcatPackage.DISTRIBUTION__CHECKSUM, oldChecksum, newChecksum);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setChecksum(Checksum newChecksum) {
		if (newChecksum != checksum) {
			NotificationChain msgs = null;
			if (checksum != null)
				msgs = ((InternalEObject)checksum).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DcatPackage.DISTRIBUTION__CHECKSUM, null, msgs);
			if (newChecksum != null)
				msgs = ((InternalEObject)newChecksum).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DcatPackage.DISTRIBUTION__CHECKSUM, null, msgs);
			msgs = basicSetChecksum(newChecksum, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DcatPackage.DISTRIBUTION__CHECKSUM, newChecksum, newChecksum));
	}
