 ...
 * @generated
 */
public class SpdxSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SpdxPackage modelPackage;
	...
	public SpdxSwitch() {
		if (modelPackage == null) {
			modelPackage = SpdxPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SpdxPackage.CHECKSUM: {
				...
				if (result == null) result = caseIdentifiedResource(checksum);
