...
public interface OrganizationType extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Has Email</b></em>' containment reference list.
	 * The list contents are of type {@link rdf.Resource}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Has Email</em>' containment reference list.
	 * @see vcard.VcardPackage#getOrganizationType_HasEmail()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='hasEmail' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<Resource> getHasEmail();

	/**
	 * Returns the value of the '<em><b>Has URL</b></em>' containment reference list.
	 * The list contents are of type {@link rdf.Resource}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Has URL</em>' containment reference list.
	 * @see vcard.VcardPackage#getOrganizationType_HasURL()
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='hasURL' namespace='##targetNamespace'"
	 * @generated
	 */
	EList<Resource> getHasURL();
