...
public class DatasetSeriesAdminResource {
	...
	public Response createDatasetSeries(DatasetSeries datasetSeries, @Context UriInfo uriInfo) {
		...
		DatasetSeries stored = datasetSeriesAdminService.upsertDatasetSeries(datasetSeries);
	...
	@Consumes({ JSON, XML, RDF_XML })
	@Produces({ JSON, XML, RDF_XML })
	public Response upsertDatasetSeries(@PathParam("id") String id, DatasetSeries datasetSeries, @Context UriInfo uriInfo) {
